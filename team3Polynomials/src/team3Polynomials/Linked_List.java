...
public class Linked_List<Term> implements Iterable<Term> {
    /** A doubly-linked list node */
    private class DNode {
    	Term data;
        DNode next, prev; 
        DNode(Term value) { data = value; }
    }
    ...
    public Linked_List(Linked_List<Term> other) {  // Copy constructor
    ...
    */
    public void addFirst(Term item) {
    ...
    */
    public boolean contains(Term target) {
        DNode p = head;
        while (p != null) {
    ...
    */
    @Override
    public List_Iterator<Term> iterator() {
        return new List_Iterator<Term>() {
            // Data fields
            ...
            */
            @Override
            public void setNext(Term value) {
                if (!hasNext()) { throw new NoSuchElementException(); }
                nextNode.data = value;
            ...
            */
            @Override
            public void setPrevious(Term value) {
                if (!hasPrevious()) { throw new NoSuchElementException(); }
                prevNode.data = value;
                previous();
            }  // Time complexity: O(1)
